...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your Host-Karo Receipt</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}/hippo-email-sent.png`}/*TODO */
                width='100'
                height='100'
                alt='Host-Karo'
              />
          ...
          <Text style={footerLinksWrapper}>
            <Link href='#'>Account Settings</Link> •{' '} {/*TODO */}
            <Link href='#'>Terms of Sale</Link> •{' '}
            <Link href='#'>Privacy Policy </Link>
          </Text>
          <Text style={footerCopyright}>
            Copyright © 2023 Host-Karo Inc. <br />{' '}
